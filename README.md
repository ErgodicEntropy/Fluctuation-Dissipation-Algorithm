...
1. Microscopic reversibility: This is problematic due to Loschmidt's paradox that prevents deriving irreversible process such as 2nd law of thermodynamics from microscopically reversible processes. This paradox has been resolved in 1895 by tweaking the molecular chaos hypothesis in that the paricles velocities, positions and therefore kinetic energies tend to correlate after collisions.  Such correlations are encoded in Boltzmann's entropy formula S = K logW (Boltzmann, 1877) which was motivated by his debate with J. Loschmidt
